...
class ShopManager {
    ...
    public function openShop(Player $player, Team $team) {
        ...
        $nbt = new CompoundTag('', [
            ...
            new StringTag('CustomName', "§b§lItem §bShop"),
    ...
    public function getItemFromArray(array $array, Team $team): Item {
        ...
        elseif($array[5][0] == 1) {
            ...
            $priceItem = Item::get(Item::EMERALD)->setCustomName("§aEmerald");
        }
    ...
    public function getBreakableBlocks(): array {
        return [Item::SANDSTONE, Item::OBSIDIAN, Item::CONCRETE, Item::WOOL, Item::END_STONE];
    }
